...
exports.generateCode = exports.generateGrid = void 0;
// 10x10 grid with random alphabetic lowercase characters.
const generateGrid = (modifier, columns, rows) => {
    const grid = [];
...
const generateCode = (grid) => {
    ...
    const firstCharCountMod = firstCharCount > 9 ? Math.floor(firstCharCount / 9) : firstCharCount;
    const secondCharCountMod = secondCharCount > 9 ? Math.floor(secondCharCount / 9) : secondCharCount;
